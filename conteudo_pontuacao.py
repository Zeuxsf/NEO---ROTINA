...
def criar_gráfico(janela):
  ...
  def segunda():
    ...
    progress = ctk.CTkProgressBar(janela,700,50,corner_radius=19)
    ...
    pontos_totais.place(x=735,y=30)
  ...
  def terça():
    ...
    pontos_totais.place(x=735,y=87)
  ...
  def quarta():
    ...
    pontos_totais.place(x=735,y=144)
  ...
  def quinta():
    ...
    pontos_totais.place(x=735,y=201)
  ...
  def sexta():
    ...
    pontos_totais.place(x=735,y=258)
  ...
  def sabado():
    ...
    pontos_totais.place(x=735,y=315)
  ...
  def domingo():
    ...
    pontos_totais.place(x=735,y=372)
...
#Área em que vai mostrar o maior pontuador  
  def maior_pontuação():
    maior_pontuação_frame = ctk.CTkFrame(janela,800,200)
